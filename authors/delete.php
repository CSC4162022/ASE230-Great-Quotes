...
if (isset($_POST['author_index'])) {
    ...
    requestDeleteAuthor($utilities->getArrayElementFromCsv('../authors.csv', $_POST['author_index']), $_POST['author_index'] );
}
//if the user submitted the delete confirmation
else if (isset($_POST['delete_confirm']) && isset($_POST['authorIndForm'])) {
    $utilities = new Utilities();
    if($_POST['delete_confirm'] == 'Yes') {
        //delete author using utility function
        $i = $_POST['authorIndForm'];
        ...
        if ($utilities->deleteRowFromCsv('../authors.csv', $i) == true
            ...
            <div>
                ...
                <a href="detail.php?index=<?=$i?>>&authorDeleted=<?=true?>"><?= 'Back' ?></a>
                <a href="../index.php">
...
function requestDeleteAuthor($author, $authorIndex)
{
?>
<html lang="en">
<head>
    ...
    <form method="post" action="delete.php">
        ...
        <div class="form-group">
            <div class="form-outline mb-4">
                <input type="hidden" name="<?='authorIndForm'?>" value="<?=$authorIndex?>" />
