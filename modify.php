...
if (isset($_POST['author_index']) && isset($_POST['quote'])) {
    $authors = getArrayFromCsv('authors.csv');
    displayModifyQuote($_POST['quote'], $_POST['author_index'], $_POST['quote_index'], $authors);
}
else if (isset($_POST['record'])) {

    if (modifyRecord('quotes.csv', $_POST['quoteIndex'], $_POST['authorIndex'], $_POST['record']) == true) {
        $j = $_POST['quoteIndex'];
        $i = $_POST['quoteIndex'];
        ?>
        <div>
 ...
 function displayModifyQuote($quote, $authorIndex, $quoteIndex, $authors) {
     ...
     <div class="container text-center">
         <form action="modify.php" method="post">
             ...
             <p><?='Modify a quote by the selected author by using the textbox below'?></p>
