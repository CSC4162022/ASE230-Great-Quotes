...
if(isset($_POST['submitModifyQuote']))
{

}
if(isset($_GET['quoteDeleted'])) {
    if ($_GET['quoteDeleted'] == true) {
...
<html lang="en">
    ...
    <?php
        ...
        $quotes = getArrayElementFromCsv('quotes.csv', $_GET['index']);
        $author = getArrayElementFromCsv('authors.csv', $_GET['index']);
    ?>
